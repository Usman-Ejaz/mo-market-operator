...
@section('addButton')
    @if (hasPermission('clients', 'delete'))
        ...
        {{-- @if ($client->approved == 0)
            <form action="{{ route('admin.clients.approve', ['client' => $client->id]) }}" method="POST">
                <button class="btn btn-success float-right mr-2" type="submit">Approve</button>
                @csrf
            </form>
        @endif --}}
    @endif
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ $detail->signature }}" class="img-thumbnail"
                                            style="width: 23%; display: block;">
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Signature: </label>
                                    <img src="{{ $client->dec_signature }}" class="img-thumbnail"
                                        style="width: 23%; display: block;">
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($client->attachments->count() > 0)
                            ...
                            <h5 class="mt-3 mb-2" style="font-weight: bold;">
                                ...
                                <a style="font-size: 1rem;font-weight: 400;"
                                    href="{{ route('admin.clients.downloadBulkFiles', ['client' => $client->id, 'category' => 0]) }}">{{ __('Download All') }}</a>
                            </h5>
                            <ol>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <li>
                                                    ...
                                                    <a
                                                        href="{{ route('admin.attachment.download', ['clients/attachments', basename($attachment->file)]) }}">{{ __('View') }}</a>
                                                </li>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @foreach ($client->categoryAttachments() as $categoryId => $attachments)
                                <h5 class="mt-3 mb-2" style="font-weight: bold;">
                                    ...
                                    <a style="font-size: 1rem;font-weight: 400;"
                                        href="{{ route('admin.clients.downloadBulkFiles', ['client' => $client->id, 'category' => $categoryId]) }}">{{ __('Download All') }}</a>
                                </h5>
                                <ol>
