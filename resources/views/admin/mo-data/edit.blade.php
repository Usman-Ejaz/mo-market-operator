...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.mo-data.index') }}">Market Operational Data</a></li>
...
@section('content')
    <div class="container-fluid">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.mo-data.add-file', ['mo_datum' => $data->id]) }}"
                            ...
                            @include('admin.mo-data.editFilesForm')
                        </form>

                        @include('admin.mo-data.fileList')
        ...
        <form method="POST" action="{{ route('admin.mo-data.update', $data->id) }}" id="update-mo-data-form">
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                        ...
                        @method('PATCH')
                        <div class="card-body">
                            @include('admin.mo-data.editForm')
                        </div>
                    </div>
                </div>
            </div>
