<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control user-autocomplete user-pm" name="pm_id" type="text" data-role="tagsinput"
                required>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control user-autocomplete user-apm" name="apm_id" type="text" data-role="tagsinput"
                required>
...
@push('optional-scripts')
    ...
    <script type="text/javascript">
        const pm = JSON.parse('{!! $department->pm !!}');
        const apm = JSON.parse('{!! $department->apm->toJson() !!}');
        ...
        $(".user-pm").tagsinput("add", pm);
        $(".user-apm").tagsinput("add", apm);
    </script>
@endpush
