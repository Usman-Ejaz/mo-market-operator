...
class SiteSearchApiController extends BaseApiController
{
     ...
     *      tags={"Site Search"},
     *      summary="Search records from the whole site. (FAQs, Jobs, Documents, News, Pages)",
     *      description="This search API will work for FAQs, News, Jobs and Pages when 'type' property is not set or 'type' property is set to 'web_content'. If the 'type' property is set to 'document' then the API will only search from the Documents Module",
